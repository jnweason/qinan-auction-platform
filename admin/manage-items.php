                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo safeOutput($row['seller_name']); ?></td>
                            <td><?php echo formatCurrency($row['start_price']); ?></td>
                            <td><?php echo $row['current_bid'] > 0 ? formatCurrency($row['current_bid']) : '無'; ?></td>
                            ...
                            <td class="action-links">
                                ...
                                <a href="view-item.php?id=<?php echo $row['id']; ?>">查看</a>
                                <a href="upload-images.php?item_id=<?php echo $row['id']; ?>">圖片</a>
                                <a href="?delete_id=<?php echo $row['id']; ?>" 
                                   class="delete-link" 
                                   onclick="return confirm('確定要刪除此商品嗎？此操作將刪除所有相關資料且無法復原！')">刪除</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
