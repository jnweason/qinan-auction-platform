...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($seller_id <= 0) {
        ...
        try {
            ...
            $stmt->bind_param("issddds", $seller_id, $name, $origin, $weight, $start_price, $reserve_price, $remarks);
        ...
        <div class="form-container">
            <form method="POST" action="">
                <div class="form-group">
                    <label for="seller_id">賣家 <span class="required">*</span></label>
                    <select id="seller_id" name="seller_id" required>
                        <option value="">請選擇賣家</option>
                        <?php while ($user = $users_result->fetch_assoc()): ?>
                            <option value="<?php echo $user['id']; ?>" <?php echo (isset($_POST['seller_id']) && $_POST['seller_id'] == $user['id']) ? 'selected' : ''; ?>>
